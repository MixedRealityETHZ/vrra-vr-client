...
namespace AsImpL
{
    ...
    public class ObjectImporter : MonoBehaviour
    {
        ...
        public Coroutine ImportModelAsync(string objName, string filePath, Transform parentObj, ImportOptions options)
        {
            if (loaderList == null)
            {
            ...
            allLoaded = false;
            return StartCoroutine(loader.Load(objName, absolutePath, parentObj));
        }
